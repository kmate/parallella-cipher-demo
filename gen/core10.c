...
#include <stdbool.h>
#include <stdint.h>
volatile bool *const la32 = (bool *) 8192;
volatile bool *const la33 = (bool *) 8208;
volatile uint32_t *const la34 = (uint32_t *) 8224;
volatile bool *const la35 = (bool *) 2293243904;
volatile bool *const la36 = (bool *) 2293243920;
volatile uint32_t *const la37 = (uint32_t *) 2293243936;
...
int main()
{
    ...
    while (1) {
        ...
        r2 = 512;
        v4 = core_read_c2c(la34, la32, la33, a3, 0, r2);
        if (!v4) {
            core_close_chan(la37, la35, la36);
            core_halt();
        }
        r5 = 512;
        v7 = core_read_c2c(la34, la32, la33, a6, 0, r5);
        if (!v7) {
            core_close_chan(la37, la35, la36);
            core_halt();
        }
        ...
        v14 = core_write_c2c(la37, la35, la36, a11, 0, r10);
        if (!v14) {
        ...
        v18 = core_write_c2c(la37, la35, la36, a16, 0, r15);
        if (!v18) {
            core_close_chan(la34, la32, la33);
            core_halt();
        }

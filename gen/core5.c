...
#include <stdbool.h>
#include <stdint.h>
volatile bool *const la17 = (bool *) 8192;
volatile bool *const la18 = (bool *) 8208;
volatile uint32_t *const la19 = (uint32_t *) 8224;
volatile bool *const la20 = (bool *) 2225086464;
volatile bool *const la21 = (bool *) 2225086480;
volatile uint32_t *const la22 = (uint32_t *) 2225086496;
...
int main()
{
    ...
    while (1) {
        ...
        r2 = 512;
        v4 = core_read_c2c(la19, la17, la18, a3, 0, r2);
        if (!v4) {
            core_close_chan(la22, la20, la21);
            core_halt();
        }
        r5 = 512;
        v7 = core_read_c2c(la19, la17, la18, a6, 0, r5);
        if (!v7) {
            core_close_chan(la22, la20, la21);
            core_halt();
        }
        ...
        v14 = core_write_c2c(la22, la20, la21, a11, 0, r10);
        if (!v14) {
        ...
        v18 = core_write_c2c(la22, la20, la21, a16, 0, r15);
        if (!v18) {
            core_close_chan(la19, la17, la18);
            core_halt();
        }

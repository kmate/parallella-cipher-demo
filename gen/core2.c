...
#include <stdbool.h>
#include <stdint.h>
volatile uint32_t *const la10 = (uint32_t *) 8224;
volatile bool *const la11 = (bool *) 2159026176;
volatile bool *const la12 = (bool *) 2159026192;
volatile uint32_t *const la13 = (uint32_t *) 2159026208;
volatile bool *const la8 = (bool *) 8192;
volatile bool *const la9 = (bool *) 8208;
...
int main()
{
    ...
    while (1) {
        ...
        r2 = 512;
        v4 = core_read_c2c(la10, la8, la9, a3, 0, r2);
        if (!v4) {
            core_close_chan(la13, la11, la12);
            core_halt();
        }
        r5 = 512;
        v7 = core_read_c2c(la10, la8, la9, a6, 0, r5);
        if (!v7) {
            core_close_chan(la13, la11, la12);
            core_halt();
        }
        ...
        v14 = core_write_c2c(la13, la11, la12, a11, 0, r10);
        if (!v14) {
            core_close_chan(la10, la8, la9);
            core_halt();
        }
        r15 = r2;
        ...
        v18 = core_write_c2c(la13, la11, la12, a16, 0, r15);
        if (!v18) {
            core_close_chan(la10, la8, la9);
            core_halt();
        }

...
#include <stdbool.h>
#include <stdint.h>
volatile uint32_t *const la10 = (uint32_t *) 2157977632;
volatile bool *const la5 = (bool *) 8192;
volatile bool *const la6 = (bool *) 8208;
volatile uint32_t *const la7 = (uint32_t *) 8224;
volatile bool *const la8 = (bool *) 2157977600;
volatile bool *const la9 = (bool *) 2157977616;
...
int main()
{
    ...
    while (1) {
        ...
        r2 = 512;
        v4 = core_read_c2c(la7, la5, la6, a3, 0, r2);
        if (!v4) {
            core_close_chan(la10, la8, la9);
            core_halt();
        }
        r5 = 512;
        v7 = core_read_c2c(la7, la5, la6, a6, 0, r5);
        if (!v7) {
            core_close_chan(la10, la8, la9);
            core_halt();
        }
        ...
        v14 = core_write_c2c(la10, la8, la9, a11, 0, r10);
        if (!v14) {
        ...
        v18 = core_write_c2c(la10, la8, la9, a16, 0, r15);
        if (!v18) {
            core_close_chan(la7, la5, la6);
            core_halt();
        }

...
int main()
{
    ...
    while (1) {
        ...
        r2 = 512;
        v4 = core_read_c2c(la37, la35, la36, a3, 0, r2);
        if (!v4) {
            core_close_chan(la40, la38, la39);
            core_halt();
        }
        r5 = 512;
        v7 = core_read_c2c(la37, la35, la36, a6, 0, r5);
        if (!v7) {
            core_close_chan(la40, la38, la39);
            core_halt();
        }
        ...
        v14 = core_write_c2c(la40, la38, la39, a11, 0, r10);
        if (!v14) {
        ...
        v18 = core_write_c2c(la40, la38, la39, a16, 0, r15);
        if (!v18) {
            core_close_chan(la37, la35, la36);
            core_halt();
        }

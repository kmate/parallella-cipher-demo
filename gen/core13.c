...
int main()
{
    ...
    while (1) {
        ...
        r2 = 512;
        v4 = core_read_c2c(la43, la41, la42, a3, 0, r2);
        if (!v4) {
            core_close_chan(la46, la44, la45);
            core_halt();
        }
        r5 = 512;
        v7 = core_read_c2c(la43, la41, la42, a6, 0, r5);
        if (!v7) {
            core_close_chan(la46, la44, la45);
            core_halt();
        }
        ...
        v14 = core_write_c2c(la46, la44, la45, a11, 0, r10);
        if (!v14) {
        ...
        v18 = core_write_c2c(la46, la44, la45, a16, 0, r15);
        if (!v18) {
            core_close_chan(la43, la41, la42);
            core_halt();
        }

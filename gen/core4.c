...
int main()
{
    ...
    while (1) {
        ...
        v3 = core_read_c2c(la16, la14, la15, a2, 0, 1);
        if (!v3) {
            core_close_chan(la19, la17, la18);
            core_halt();
        }
        v4 = a2[0];
        v6 = core_read_c2c(la16, la14, la15, a5, 0, 1);
        if (!v6) {
            core_close_chan(la19, la17, la18);
            core_halt();
        }
        ...
        r9 = (((a1[r8 >> 24] + a1[(r8 >> 16 & 255) + 256]) ^ a1[(r8 >> 8 &
                                                                 255) + 512]) +
              a1[(r8 & 255) + 768]) ^ v7;
        v10 = core_write_c2c(la19, la17, la18, &r9, 0, 1);
        if (!v10) {
            core_close_chan(la16, la14, la15);
            core_halt();
        }
        r11 = r8;
        v12 = core_write_c2c(la19, la17, la18, &r11, 0, 1);
        if (!v12) {
            core_close_chan(la16, la14, la15);
            core_halt();
        }
